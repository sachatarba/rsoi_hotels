...
import (
	...
	v1 "github.com/sachatarba/rsoi_hotels/internal/payments/delivery/http/v1"
	"github.com/sachatarba/rsoi_hotels/internal/payments/domain/services"
	"log/slog"
	"net/http"
)

func NewRouter(app *gin.Engine, cfg *config.Config, service services.IPaymentService, logger *slog.Logger) {
	...
	{
		v1.NewPaymentRoutes(apiV1Group, service, logger)
	}
}
